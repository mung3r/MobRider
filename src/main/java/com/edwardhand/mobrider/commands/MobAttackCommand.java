...
public class MobAttackCommand extends BaseCommand
{
    private MobRider plugin = null;

    public MobAttackCommand(MobRider plugin)
    {
        this.plugin = plugin;
    ...
    public void execute(CommandSender commandSender, String[] args)
    {
        ...
        if (vehicle instanceof EntityCreature) {
            ...
            if (target != null) {
                plugin.getMobManager().setFollowing(player, target, MobIntent.ATTACK);
